...
\let\subparagraph\llncssubparagraph\begin{document}
...
\begin{tikzpicture}
 ...
 \node[opacity=0.3,inner sep=0pt,remember picture,overlay] at (4.5,-3){\includegraphics[width= 0.55 \textwidth]{_extensions/bbpdf/partials/figures/0. general/bb_logo_gray.png}};

\node[inner sep=0pt] (logo) at (0,0)
    {\includegraphics[width=.2\textwidth]{_extensions/bbpdf/partials/figures/0. general/bb_logo.png}};
    
\node[text width = 0.5\textwidth, right = of logo](title){\sffamily\huge hello};
...
\hypertarget{some-more}{%
\subsection{Some more}\label{some-more}}

Even more stuff This is a Quarto book.
